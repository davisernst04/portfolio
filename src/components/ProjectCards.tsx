...
const cards = [
  ...
  {
    title: "Davis Corner",
    description: "Technical Blog & Personal Writing",
    src: "/photos/davis_corner.png",
    githubLink: "https://github.com/davisernst04/portfolio",
    ...
    content: () => (
      <p>
        A technical blog and personal writing space built into this portfolio
        site. Features a custom CMS with admin authentication, a rich text
        editor, and dynamic post rendering with SEO-optimized metadata.
        <br /><br />
        Powered by Better Auth for session management, Prisma ORM for
        content storage, and server-side rendering for fast page loads.
      </p>
    ),
  },
];
